  ...
  return (
    <svg width="20" height="10" viewBox="0 0 20 10" fill="none" {...props}>
      ...
      <path
        ...
        className="fill-slate-200 dark:fill-zinc-200"
      />
      <path
