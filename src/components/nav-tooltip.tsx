...
export function NavTooltipTrigger({
  ...
  return (
    <Tooltip.Trigger className="flex size-8 items-center justify-center select-none" render={as} />
  )
}
