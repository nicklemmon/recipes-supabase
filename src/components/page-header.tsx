...
export function PageHeader({ children }: { children: React.ReactNode }) {
  return (
    <div className="pb-6 pt-14 md:pb-20 md:pt-14 relative overflow-hidden bg-indigo-50 dark:bg-zinc-900">
      <div className="absolute inset-0 bg-linear-180 from-indigo-50 via-transparent to-blue-100 dark:from-transparent dark:via-transparent dark:to-transparent" />
